...
|------|-------------|------|---------|:--------:|
| <a name="input_allow_ip_capacity"></a> [allow\_ip\_capacity](#input\_allow\_ip\_capacity) | Number of rules this rule group will contain | `number` | `25` | no |
...
| <a name="input_block_domain_capacity"></a> [block\_domain\_capacity](#input\_block\_domain\_capacity) | Number of rules this rule group will contain | `number` | `25` | no |
...
| <a name="input_block_ip_capacity"></a> [block\_ip\_capacity](#input\_block\_ip\_capacity) | Number of rules this rule group will contain | `number` | `25` | no |
